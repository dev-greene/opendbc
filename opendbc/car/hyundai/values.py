...
class HyundaiFlags(IntFlag):
  ...
  # Carnival 2025+ uses ccNC two-screen cluster; HDA2 uses LFAHDA_CLUSTER with different signals
  CCNC = 2 ** 27
...
class CAR(Platforms):
  ...
  KIA_CARNIVAL_2025 = HyundaiCanFDPlatformConfig(
    ...
    CarSpecs(mass=2087, wheelbase=3.09, steerRatio=14.23),
    flags=HyundaiFlags.CCNC | HyundaiFlags.UNSUPPORTED_LONGITUDINAL | HyundaiFlags.CANFD_ALT_BUTTONS | HyundaiFlags.CANFD_RADAR_SCC,
  )
